...
% load('fms_factors_randrandPi_Max200_f1.mat', 'fms_factors')
% load('fms_pi_randrandPi_Max200_f1.mat', 'fms_pi')
% load('loss_obj_randrandPi_Max200_f1.mat', 'loss_obj')
% load('loss_pi_randrandPi_Max200_f1.mat', 'loss_pi')
% load('AccPi_randrandPi_Max200_f1.mat', 'AccPi')
...
while(iter <= number_testcase)
    ...
    % [learnedPermu, initPermu, accPi, Loss_obj, Loss_pi] = tensor_align_f2_chemCMTF(Z, MaxMostOuterIter, thresholdResObj, lambda, 'rand', 'randPi', k_cluster, guessRank, truePermu, '', '', '');
    ...
    % save('fms_factors_randrandPi_Max200_f1.mat','fms_factors')
    % save('fms_pi_randrandPi_Max200_f1.mat','fms_pi')
    save('loss_obj_randrandPi_Max200_f1.mat','loss_obj')
    save('loss_pi_randrandPi_Max200_f1.mat','loss_pi')
    save('AccPi_randrandPi_Max200_f1.mat','AccPi')
...
saveas(gcf,'figure_randrandPi_Max200.png')
